                ...
                For i = 0 To sintomas.Length - 1
                    If sintomasEmpleado.Item(j).Equals(sintomas.GetValue(i)) Then
                        ...
                        If v.Destino1.Codigo1.Equals(enf._localización) Then
                            RichTextBox1.Text = "De acuerdo a los síntomas introducidos,
los viajes realizados por el empleado y la información de las distintas enfermedades registradas, 
el empleado puede sufrir: " + vbNewLine + vbNewLine + enf._nombre.ToUpper + vbNewLine + vbNewLine + "Una posible cura 
para esta enfermedad es: " + enf._cura

                        Else
                            RichTextBox1.Text = "Los síntomas del empleado no coinciden con ninguna 
enfermedad grave localizada en los países que ha visitado."
                        End If
                    End If
                Next
            Next
